...
// hackathon mock data. Safe to re-run: wipes the same 24 tables (children
// first) before reloading. Run with: bun run db:seed
...
// children first — mirrors the FK graph in db/schema.sql
